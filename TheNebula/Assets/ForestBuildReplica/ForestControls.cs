...
public partial class @ForestControls : IInputActionCollection2, IDisposable
{
    ...
    public struct PlayerActiveActions
    {
        ...
        {
            if (m_Wrapper.m_PlayerActiveActionsCallbackInterface != null)
            {
                @Move.started -= m_Wrapper.m_PlayerActiveActionsCallbackInterface.OnMove;
                @Move.performed -= m_Wrapper.m_PlayerActiveActionsCallbackInterface.OnMove;
                @Move.canceled -= m_Wrapper.m_PlayerActiveActionsCallbackInterface.OnMove;
